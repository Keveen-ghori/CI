...
namespace CommunityInvestment.Data;
...
public partial class CiContext : DbContext
{
    ...
    public virtual DbSet<SpFilterModel> GetMissions { get; set; }
    public virtual DbSet<spMissionRating> GetMissionRatings { get; set; }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<spMissionRating>(entity => entity.HasNoKey());
        modelBuilder.Entity<SpFilterModel>(entity => entity.HasNoKey());
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admin__4A311D2F18BFB626");

            entity.ToTable("Admin");

            entity.HasIndex(e => e.Email, "UQ__Admin__A9D105349A45D559").IsUnique();
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__Banner__8174A02CE208606E");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__City__DE9CEC38B9D7BE50");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52A028F8DA");
        ...
        modelBuilder.Entity<Comment>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany()
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Comment__Mission__6383C8BA");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__8037C7D66174D1D2");
        ...
        {
            entity.HasKey(e => e.FavouritMissionId).HasName("PK__favourit__16E34B4CF74CD615");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.FavouritMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__favourit___Missi__70DDC3D8");

            entity.HasOne(d => d.User).WithMany(p => p.FavouritMissions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__favourit___User___6EF57B66");
        });

        modelBuilder.Entity<GoalMission>(entity =>
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7540CD590");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.GoalMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__goal_miss__Missi__76969D2E");
        });

        modelBuilder.Entity<Mission>(entity =>
        {
            entity.HasKey(e => e.MissionId).HasName("PK__Mission__93DC24EA5D964DEB");
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Missions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Mission__City_id__5AEE82B9");

            entity.HasOne(d => d.Country).WithMany(p => p.Missions)
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Mission__Country__5CD6CB2B");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A16DFE7D1");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_a__Missi__7C4F7684");

            entity.HasOne(d => d.User).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_a__User___7E37BEF6");
        });

        modelBuilder.Entity<MissionDocument>(entity =>
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___537947661EAE276C");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionDocuments)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_d__Missi__04E4BC85");
        });

        modelBuilder.Entity<MissionInvite>(entity =>
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A1126E84CCE216D0");
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.MissionInviteFromUsers)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_i__from___0C85DE4D");

            entity.HasOne(d => d.Mission).WithMany(p => p.MissionInvites)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_i__Missi__0A9D95DB");

            entity.HasOne(d => d.ToUser).WithMany(p => p.MissionInviteToUsers)
                .HasForeignKey(d => d.ToUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_i__to_us__0E6E26BF");
        });

        modelBuilder.Entity<MissionMedium>(entity =>
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E82F67CCA7");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionMedia)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_m__Missi__14270015");
        });

        modelBuilder.Entity<MissionRating>(entity =>
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E5172C58DEFE6");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__Missi__1CBC4616");

            entity.HasOne(d => d.User).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__User___1AD3FDA4");
        });

        modelBuilder.Entity<MissionSkill>(entity =>
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___8271200895F25EAF");
            ...
            entity.HasOne(d => d.Skill).WithMany(p => p.MissionSkills)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_s__skill__282DF8C2");
        });

        modelBuilder.Entity<ResetPassword>(entity =>
        {
            entity.HasKey(e => e.Token).HasName("PK__reset_pa__1EB4F8166D4D7296");

            entity.ToTable("reset_password", tb => tb.HasTrigger("Token_delete_trigger"));
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__Skills__B4AAE688C776A590");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C56E7C91EF3");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Stories)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story__Mission_i__3493CFA7");

            entity.HasOne(d => d.User).WithMany(p => p.Stories)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story__User_id__32AB8735");
        });

        modelBuilder.Entity<StoryMedium>(entity =>
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053CACCB2E18");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__stoty_in__04497867658D318D");
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.StotyInviteFromUsers)
                .HasForeignKey(d => d.FromUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__stoty_inv__from___3D2915A8");

            entity.HasOne(d => d.Story).WithMany(p => p.StotyInvites)
                .HasForeignKey(d => d.StoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__stoty_inv__story__3C34F16F");

            entity.HasOne(d => d.ToUser).WithMany(p => p.StotyInviteToUsers)
                .HasForeignKey(d => d.ToUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__stoty_inv__to_us__3F115E1A");
        });

        modelBuilder.Entity<Theme>(entity =>
        {
            entity.HasKey(e => e.ThemeId).HasName("PK__Theme__59291A6A5B666BE5");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068660DAA5A");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Timesheets)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__timesheet__Missi__4C6B5938");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__206A9DF864006C51");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053404037B4F").IsUnique();
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Users)
                .HasForeignKey(d => d.CityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Users__City_id__4BAC3F29");

            entity.HasOne(d => d.Country).WithMany(p => p.Users)
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Users__Country_i__4D94879B");
        });

        modelBuilder.Entity<UserSkill>(entity =>
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BDFCCD6A8");
            ...
            entity.HasOne(d => d.Skill).WithMany(p => p.UserSkills)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_skil__skill__55009F39");

            entity.HasOne(d => d.User).WithMany(p => p.UserSkills)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_skil__User___531856C7");
        });
